...
It seamlessly integrates with GitHub and AWS to simplify CI/CD workflows for developers and teams.

Visit: <a href="http://launchly.software">launchly.software</a>

## Demo Deployed Sites<br>
...
| **Cloud**           | AWS S3, API Gateway, Lambda, Cloudflare Tunnel |
| **Database**        | AWS DynamoDB                                   |
| **Version Control** | GitHub Integration                             |
| **Monitoring**      | AWS CloudWatch, Custom Log Parser              |
